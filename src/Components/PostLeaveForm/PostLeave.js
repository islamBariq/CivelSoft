          ...
          <div className={classes.info}>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className={classes.employee_info}>
                          <p>
                            {employee.code}|{employee.name}|{employee.jobTitle}|
            ...
            <div className={classes.info__description}>
              ...
              <div className='description'>
                ...
                <h5>
                  Job Title: <span>{this.state.selectedEmployee.jobTitle}</span>{' '}
                </h5>
                <h5>
                  Salary Profile:{' '}
                ...
                >
                  ...
                  <div className={classes.form__date}>
                    <div className={classes.form__date__left}>
                      <label htmlFor='leave'>Expected Leaving Date</label>
                      <input
                        required
                        type='date'
                        id='leave'
                    ...
                    <div className={classes.form__date__Right}>
                      <label htmlFor='rejoin'>Expected Rejoining Date</label>
                      <input
                        required
                        type='date'
                        id='rejoin'
